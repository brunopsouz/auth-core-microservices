...
{
    private const string ActivitySourceName = "NotificationCore.IntegrationTests.Npgsql";
    private const string DataSourceName = "notificationcore-postgresql";
    ...
    [PostgreSqlFact("NOTIFICATIONCORE_TEST_POSTGRES")]
    ...
    private static async Task EnsurePostgreSqlAvailableAsync()
    {
        ...
        {
            const string message = "Configure NOTIFICATIONCORE_TEST_POSTGRES para executar a validação real de telemetria Npgsql.";
    ...
    private static string GetRequiredConnectionString()
    {
        return GetConfiguredConnectionString()
            ?? throw new InvalidOperationException("Configure NOTIFICATIONCORE_TEST_POSTGRES para executar a validação real de telemetria Npgsql.");
    }

    private static string? GetConfiguredConnectionString()
    {
        return Environment.GetEnvironmentVariable("NOTIFICATIONCORE_TEST_POSTGRES");
    }
